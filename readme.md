...
Because our C code was smartly designed to use default limits (40MB and 64MB) even when you didn't type the flags, your memory_hog program hit those invisible walls and triggered the exact dmesg kernel logs was asked for.
